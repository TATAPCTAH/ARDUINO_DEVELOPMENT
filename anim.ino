...
void strange_ring() {
    for (int i = 0; i < 16; ++i)
    {
      ...
      pixels.setPixelColor((i + 1) % 16, pixels.Color(0, 150, 150));
      pixels.setPixelColor((i + 2) % 16, pixels.Color(0, 200, 200));
      pixels.setPixelColor((i + 3) % 16, pixels.Color(50, 50, 0));
      pixels.setPixelColor((i + 4) % 16, pixels.Color(255, 255, 0));
      pixels.setPixelColor((i + 5) % 16, pixels.Color(0, 150, 150));
      pixels.setPixelColor((i + 6) % 16, pixels.Color(0, 200, 200));
      pixels.setPixelColor((i + 7) % 16, pixels.Color(50, 50, 0));
      pixels.setPixelColor((i + 8) % 16, pixels.Color(255, 255, 0));
      pixels.setPixelColor((i + 9) % 16, pixels.Color(0, 150, 150));
      pixels.setPixelColor((i + 10) % 16, pixels.Color(0, 200, 200));
      pixels.setPixelColor((i + 11) % 16, pixels.Color(50, 50, 0));
      pixels.setPixelColor((i + 12) % 16, pixels.Color(255, 255, 0));
      pixels.setPixelColor((i + 13) % 16, pixels.Color(0, 150, 150));
      pixels.setPixelColor((i + 14) % 16, pixels.Color(0, 200, 200));
      pixels.setPixelColor((i + 15) % 16, pixels.Color(50, 50, 0));
      pixels.show();
      delay(50);
    }
}
